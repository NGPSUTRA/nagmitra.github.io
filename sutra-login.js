...
async function loadCSV() {
    try {
        ...
        const response = await fetch(`https://docs.google.com/spreadsheets/d/e/2PACX-1vTnGJsECSsHaqp1pQySQZ7SzjCCBRxaWU9o2L5rMb_cdYpDieAVexbfrrPviD1NK17RVFwBJeE2eGpi/pub?gid=0&single=true&output=csv&nocache=${cacheBuster}`);
